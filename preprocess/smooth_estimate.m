%-----------------------------------------------------------------------
%This script is to smooth the functional data, specifiy model, model
%estimation and contrast.
%Input: functional image(*8_1.nii)
...
for n=1:length(all)
    ...
    matlabbatch{1}.spm.spatial.smooth.data = Pcell;
    matlabbatch{1}.spm.spatial.smooth.fwhm = [3 3 3];
    matlabbatch{1}.spm.spatialsmooth.dtype = 0;
    matlabbatch{1}.spm.spatial.smooth.im = 0;
    matlabbatch{1}.spm.spatial.smooth.prefix = 's';
%     matlabbatch{2}.spm.stats.fmri_spec.dir = {['/g5/kirby/xmiao5/XZhou86/Model free method/1st_Level/',all{n}]};
